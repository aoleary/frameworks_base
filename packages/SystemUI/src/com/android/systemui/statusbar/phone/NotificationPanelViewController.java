...
import com.android.systemui.XtendedSystemUIUtils;
...
public class NotificationPanelViewController extends PanelViewController {
    ...
    public void reTickerView(boolean visibility) {
        if (!XtendedSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) return;
        ...
        if (visibility && getExpandedFraction() != 1) {
            ...
            if (XtendedSystemUIUtils.settingStatusBoolean("reticker_colored", mView.getContext())) {
                int col;
    ...
    private void reTickerViewVisibility() {
        if (!XtendedSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) {
            reTickerDismissal();
            return;
        }
